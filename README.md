...
| REQ27          | The answers page should contain at least one or more dropdown                                                                                          | Answers              |
| REQ28          | If the user is a teacher, they should be able to select any user in order to view their answers                                                        | Answers              |
| REQ29          | If the user is a student automatically select themselves as the account                                                                                | Answers              |
| REQ30          | Once a question has been selected, all answers the user selected has written for that question should be displayed                                     | Answers              |
...
| TEST29  | Confirm one or more drop-down menus are present on the page                                                                        | ✅                                                                        | 10:29                                                       |
| TEST30  | Verify that if the user is a teacher, they can select which student they would like to access                                      | ✅                                                                        | 10:43                                                       |
| TEST31  | Verify that if the user is a student, their user is automatically selected for them                                                | ✅                                                                        | 11:09                                                       |
| TEST32  | Verify that if the user is a student they have no access to other student's answers                                                | ✅                                                                        | 11:23                                                       |
| TEST33  | Once a question has been selected by a user, verify that all answers the selected user has written for that question are displayed | ✅                                                                        | 11:48                                                       |
...
#### Objectives Review
| Requirement ID | Description                                                                                                                                            | Category             | Completed | Rel. Test |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------- | --------- | --------- |
| REQ1           | There should be a web platform for the user to view and use                                                                                            | Layout               | ✅         | TEST1     |
| REQ2           | There should be 6 pages: Landing, Questions, Categories, Assignments, Question, Answers                                                                | Layout               | ✅         | TEST2     |
| REQ3           | The landing page should restrict navigation by hiding the navigation menu options unless logged in                                                     | Landing              | ✅         | TEST3     |
| REQ4           | The landing page should also have a login button                                                                                                       | Landing              | ✅         | TEST4     |
| REQ5           | When the login button is pressed, the user should be prompted to login using google authentication                                                     | Login                | ✅         | TEST5     |
| REQ6           | If an account does not exist, an account should be made automatically on the behalf of the user                                                        | Login                | ✅         | TEST6     |
| REQ7           | Once logged in, buttons for navigation should be visible on the left                                                                                   | Layout               | ✅         | TEST7     |
| REQ8           | A student user should be allowed navigation to 4 pages from any other page once logged in: Categories, Questions, Assignments, and Answers             | Layout               | ✅         | TEST8     |
| REQ9           | A student user should be taken automatically to assignments on login                                                                                   | Login                | ✅         | TEST9     |
| REQ10          | If the user has assignments due, they should be present in a table                                                                                     | Assignments          | ✅         | TEST10    |
| REQ11          | The table should have navigable links to each relevant question page                                                                                   | Assignments          | ✅         | TEST11    |
| REQ12          | If there are no assignments due, then a message as "No assignments" should be displayed                                                                | Assignments          | ✅         | TEST12    |
| REQ13          | The categories page should have a table displaying the question categories                                                                             | Categories           | ✅         | TEST13    |
| REQ14          | Each category should have relevant data displayed, such as the ID and name                                                                             | Categories           | ✅         | TEST14    |
| REQ15          | Each category should have a navigable link that takes you to the questions page                                                                        | Categories           | ✅         | TEST15    |
| REQ16          | When navigating from the categories links to the questions page, the questions should be filtered to the specified category                            | Categories/Questions | ✅         | TEST16    |
| REQ17          | The question page should display a table displaying the questions                                                                                      | Questions            | ✅         | TEST17    |
| REQ18          | The table should display relevant data such as the ID, name, and question text                                                                         | Questions            | ✅         | TEST18    |
| REQ19          | Each question should have a navigable link that takes you to the specified question page                                                               | Questions/Question   | ✅         | N/A       |
| REQ20          | The question page should contain all of the relevant data, such as starting code, examples, tests, text, and any other relevant information if present | Question             | ✅         | N/A       |
| REQ21          | If the data is not present in the database, it should remain hidden                                                                                    | Question             | ✅         | TEST20    |
| REQ22          | There should be a text-box for the user to insert their answer into                                                                                    | Question             | ✅         | TEST21    |
| REQ23          | There should be a button at the bottom of the question page which allows the user to submit their answer for the question                              | Question             | ✅         | TEST22    |
| REQ24          | The question page should confirm whether or not the answer was submitted successfully                                                                  | Question             | ✅         | TEST23    |
| REQ25          | If there was an error submitting the answer, a potential reason should be explained in the confirmation                                                | Question             | ✅         | TEST24    |
| REQ26          | From every page there should be a button to log out                                                                                                    | Layout               | ✅         | TEST25    |
| REQ27          | The name of the logged-in user should be displayed at the top of every page                                                                            | Layout               | ✅         | TEST27    |
| REQ28          | The answers page should contain at least one or more dropdown                                                                                          | Answers              | ✅         | TEST29    |
| REQ29          | If the user is a teacher, they should be able to select any user in order to view their answers                                                        | Answers              | ✅         | TEST30    |
| REQ30          | If the user is a student automatically select themselves as the account                                                                                | Answers              | ✅         | TEST31    |
| REQ31          | Once a question has been selected, all answers the user selected has written for that question should be displayed                                     | Answers              | ✅         | TEST33    |
